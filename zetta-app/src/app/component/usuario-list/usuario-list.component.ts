...
export class UsuarioListComponent implements OnInit {
  ...
  colunas: { field: string, label: string, sort: string, width: string }[] = [
      { field: 'dataCadastro', label: 'Data de Cadastro', sort: 'dataCadastro', width: 'auto' },
      { field: 'nome', label: 'Nome', sort: 'nome', width: 'auto' },
      { field: 'cpf', label: 'CPF', sort: 'cpf', width: 'auto' },
      { field: 'dataNascimento', label: 'Data de Nascimento', sort: 'dataNascimento', width: 'auto' },
      { field: 'sexo', label: 'Sexo', sort: 'sexo', width: 'auto' },
      { field: 'cargo', label: 'Cargo', sort: 'cargo', width: 'auto' },
  ];
